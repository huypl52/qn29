...
import ItemHistoryTranslate from "~/component/LeftBar/ItemHistoryTranslate.tsx";
import ItemSavedText from "~/component/LeftBar/ItemSavedText.tsx"; // Import icons


const SavedText: React.FC<{ updateViewHistory: (status: boolean) => void }> = ({ updateViewHistory }) => {
    return (
