...
import ItemHistoryTranslate from "~/component/LeftBar/ItemHistoryTranslate.tsx"; // Import icons


const HistoryTranslate: React.FC<{ updateViewHistory: (status: boolean) => void }> = ({ updateViewHistory }) => {
    return (
